...
If you don't want to send model properties that are not included in your **Select** request, you can use the *
GetOnlySelectedProperties* extension method, which will render you only the selected properties. Example:
